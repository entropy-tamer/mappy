...
fn main() -> anyhow::Result<()> {
    ...
    let input = "2007 3_toes 4_fingers anthro biped black_and_white breasts canid canine";
    let tags = parser.parse(input)?;
    
    println!("Testing {} tags, {} bytes original\n", tags.len(), input.len());
    ...
    println!("  Compression (100x, corpus built): {:.4} ms per operation", compress_time);
