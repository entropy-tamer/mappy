...
fn main() -> anyhow::Result<()> {
    ...
    println!("  Parsed {} tags, {} bytes original", tags2.len(), input2.len());
    ...
    println!("  Generated {} tags, {} bytes total", tags3.len(), original_size3);
    ...
    println!("  Parsed {} tags, {} bytes original", tags4.len(), input4.len());
    ...
    for (name, tags) in test_cases {
        ...
        let mut named_comparisons = comparisons.into_iter().map(|mut c| {
    ...
    let report_path = ReportGenerator::generate_storage_report(&all_comparisons, "reports/comprehensive_storage_report.html")?;
    ...
    ChartGenerator::compression_ratio_chart(&algo_results, "reports/algorithm_compression_ratio.png")?;
    ChartGenerator::speed_comparison_chart(&algo_results, "reports/algorithm_speed_comparison.png")?;
